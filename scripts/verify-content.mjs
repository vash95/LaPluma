...
const requiredSnippets = [
  ...
  'Funkos personalizados y manualidades únicas para regalar emociones.',
  'Piezas artesanales para cada ocasión',
  'Un encargo sencillo, cercano y cuidado',
  'Inspiración para tu próximo regalo',
  'English',
  'Català',
  'Custom Funkos and unique crafts made to gift emotions.',
  'Funkos personalitzats i manualitats úniques per regalar emocions.',
  'language-switcher',
  'function Header',
  'function Hero',
  'function About',
